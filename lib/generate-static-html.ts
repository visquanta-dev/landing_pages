...
<body>
  ...
  <div style="padding:140px 48px 100px;max-width:720px;margin:0 auto;animation:fadeUp 0.5s cubic-bezier(0.16,1,0.3,1)">
    ...
    <div style="font-size:14px;color:#666;line-height:1.85;font-weight:300">
      ...
      <p style="margin-bottom:16px">When you provide your mobile phone number through a form on this website and check the SMS consent box, you agree to receive recurring text messages from ${esc(d.legal_entity_name)}${d.dba_name ? ` (DBA ${esc(d.dba_name)})` : ''}, including appointment confirmations, reminders, and account-related notifications. Consent is not a condition of purchase.</p>
